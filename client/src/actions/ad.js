...
import { REACT_APP_API_BASE_URL } from "../api/api";
  ...
  async (dispatch) => {
    ...
    try {
      const res = await axios.get(
        `${REACT_APP_API_BASE_URL}/ad?option=notexpired`,
        config
      );
...
export const loadAdDetails = (adId) => async (dispatch) => {
  try {
    ...
    const res = await axios.get(`${REACT_APP_API_BASE_URL}/ad/${adId}`);
...
export const loadHighestBid = (adId) => async (dispatch) => {
  const url = `${REACT_APP_API_BASE_URL}/bid/${adId}`;
  try {
...
export const postAd = (data) => async (dispatch) => {
  const url = `${REACT_APP_API_BASE_URL}/ad`;
  try {
...
export const startAuction = (adId) => async (dispatch) => {
  const url = `${REACT_APP_API_BASE_URL}/auction/start/${adId}`;
  try {
...
export const getUserPurchasedAds = () => async (dispatch) => {
  const url = `${REACT_APP_API_BASE_URL}/user/products/purchased`;
  try {
    const res = await axios.get(url);
